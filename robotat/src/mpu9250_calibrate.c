...
// Calibración predeterminada es no tener ninguna
...
void calibrate_mag(void){
  ...
  ESP_LOGI(TAG, "Rotate the magnometer around all 3 axes, until the min and max values don't change anymore.");
